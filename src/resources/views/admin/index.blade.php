...
<body id="page-top">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="common/img/undraw_posting_photo.svg" alt="...">
                                    </div>
    ...
    <!-- Page level plugins -->
    <script src="{{ env('SITE_URL') }}/common/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="{{ env('SITE_URL') }}/common/js/demo/chart-area-demo.js"></script>
    <script src="{{ env('SITE_URL') }}/common/js/demo/chart-pie-demo.js"></script>
</body>
