            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">キービジュアル編集</h1>
                    </div>

                    <div class="form-wrap">
                        <form method="POST" action="{{ route('user.edit-confirm') }}">
                            @csrf
                            <input type="hidden" value="{{ $key_visual->id }}" name="id">
                            <div class="mb-3 row">
                                <label for="inputName" class="col-sm-2 col-form-label">管理者名</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" value="{{ $key_visual->name }}" class="form-control" id="inputName">
                                    @if($errors->has('name'))
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="login_id" value="{{ $key_visual->login_id }}" class="form-control" id="inputId">
