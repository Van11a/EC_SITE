                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">EC SITE管理画面</h1>
                                    </div>
                                    @if (count($errors))
                                    <!-- エラーチェック -->
                                    <div class="form-error">
                                        <div class="alert alert-danger" role="alert">
                                            <p><i class="fal fa-exclamation-circle pr-2"></i>ログインIDもしくはパスワードに誤りがあります</p>
                                        </div>
                                    </div>
                                    <!-- End エラーチェック -->
                                    @endif
                                    <form method="POST" action="{{ route('login') }}" class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                name="login_id" id="login_id" required="required" 
                                                placeholder="ログインID">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-secondary btn-user btn-block">ログイン</button>
                                    </form>
                                </div>
                            </div>
                        </div>
