...
@php
    for($i=1; $i<=5; $i++){
        ${'imageUrl' . $i} = '';
        if (old('image' . $i)) {
            ${'imageUrl' . $i} = Storage::url(old('image'. $i));
        } elseif (old('before_image'. $i)) {
            ${'imageUrl' . $i} = Storage::url(old('before_image'. $i));
        }
    }
@endphp
                ...
                <div class="form-wrap">
                    <form method="POST" action="{{ route('goods.create-confirm') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="part_number" class="form-control" id="inputPartNumber" value="{{ old('part_number') }}">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="d-flex align-items-center">
                                    @if(old('before_image1'))
                                        <input type="hidden" name="before_image1" value="{{ old('before_image1') }}">
                                    @endif
                                    ...
                                    <span id="fileNameDisplay1" class="text-muted">
                                        @if( old('before_image1') )
                                            {{ old('before_image1') }}
                                        @else
                                            選択されていません
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="d-flex align-items-center">
                                    @if(old('before_image2'))
                                        <input type="hidden" name="before_image2" value="{{ old('before_image2') }}">
                                    @endif
                                    ...
                                    <span id="fileNameDisplay2" class="text-muted">
                                        @if( old('before_image2') )
                                            {{ old('before_image2') }}
                                        @else
                                            選択されていません
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="d-flex align-items-center">
                                    @if(old('before_image3'))
                                        <input type="hidden" name="before_image3" value="{{ old('before_image3') }}">
                                    @endif
                                    ...
                                    <span id="fileNameDisplay3" class="text-muted">
                                        @if( old('before_image3') )
                                            {{ old('before_image3') }}
                                        @else
                                            選択されていません
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="d-flex align-items-center">
                                    @if(old('before_image4'))
                                        <input type="hidden" name="before_image4" value="{{ old('before_image4') }}">
                                    @endif
                                    ...
                                    <span id="fileNameDisplay4" class="text-muted">
                                        @if( old('before_image4') )
                                            {{ old('before_image4') }}
                                        @else
                                            選択されていません
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="d-flex align-items-center">
                                    @if(old('before_image5'))
                                        <input type="hidden" name="before_image5" value="{{ old('before_image5') }}">
                                    @endif
                                    ...
                                    <span id="fileNameDisplay5" class="text-muted">
                                        @if( old('before_image5') )
                                            {{ old('before_image5') }}
                                        @else
                                            選択されていません
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="stock" class="form-control" id="inputStock" value="{{ old('stock') }}">
                                @if($errors->has('stock'))
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="cost" class="form-control" id="inputCost" value="{{ old('cost') }}">
                                @if($errors->has('cost'))
